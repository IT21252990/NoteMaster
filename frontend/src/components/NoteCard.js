  ...
  return (
    <>
      <div onClick={() => setOpen(true)}>
        <article className="flex flex-col items-start justify-between rounded-lg shadow-lg ">
      ...
      <Transition.Root show={open} as={React.Fragment}>
        ...
        >
          <div className="fixed inset-0 z-10 flex items-center justify-center">
            ...
            >
              <div className="relative w-full max-h-full mx-auto overflow-hidden bg-white rounded-lg shadow-xl sm:w-1/2 md:w-full lg:w-1/2 sm:mx-0">
                  ...
                  <div className="">
                    ...
                    <div className="mt-10 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="absolute mt-11 ">
                        <p className="text-sm text-gray-500">{formattedDistance}</p>
                      </div>
                    </div>
                  </div>
                </div>
